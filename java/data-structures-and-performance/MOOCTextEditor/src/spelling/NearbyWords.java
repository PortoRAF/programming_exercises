	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while (!queue.isEmpty()) {
			...
			if (curr != null && !visited.contains(curr)) {
				List<String> currList = distanceOne(curr, wordsOnly);
				for (int i = 0; i < currList.size(); i++) {
					if (retList.size() < numSuggestions) {
						String retWord = currList.get(i);
						if (!retList.contains(retWord)) retList.add(retWord);
					}
					else {
						return retList;
					}
   ...
   public static void main(String[] args) {
	   ...
	   */
	   ...
	   /*
		...
		currentList = nw.suggestions(s, 5);
		...
		t = "t";
		nw.insertions(t, currentList, wordsOnly);
		System.out.println(currentList);
		
		currentList.clear();		
		t = "walke";
		nw.substitution(t, currentList, wordsOnly);
		nw.insertions(t, currentList, wordsOnly);
		nw.deletions(t, currentList, wordsOnly);
		System.out.println(currentList);
